...
import type { ErythroDerived, ErythroState } from './engine/types';
import type { ErythroPresetName } from './engine/presets';
...
/** Size and reticulocyte response — between them these two split almost every anaemia, which
 * is exactly how the workup runs at the bedside. */
const PANEL = [
