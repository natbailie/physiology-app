...
import type { FrameNode, ModulePresentation, PresentationContext, SceneNode } from '@/shared/presentation/types';
...
export function buildHypersensitivityPresentation(ctx: Ctx): ModulePresentation<HypersensitivityState, HypersensitivityDerived, HypersensitivityInputs, HypersensitivityHistoryPoint> {
  ...
  const graph: FrameNode = {
    ...
    children: [
      ...
      // Above the axis rather than beside it: at PLOT.top + 6 it sat on the "100" tick.
      { type: 'text', x: PLOT.left, y: PLOT.top - 8, text: '%', cls: 'tickLabel', anchor: 'end' },
  ...
  const mechanisms: FrameNode = {
    ...
    children: [
      ...
      ...mastCellChildren,
      // Each arm's card carries two two-line notes; 12 units left them touching at 11px.
      { type: 'text', x: 60, y: 126, text: 'preformed granules', cls: 'caption', anchor: 'middle' },
      { type: 'text', x: 60, y: 140, text: 'minutes', cls: 'caption', anchor: 'middle' },
      { type: 'text', x: 60, y: 156, text: `wheal ${derived.whealMm.toFixed(0)} mm`, cls: 'caption', anchor: 'middle' },
      ...
      ...targetCellChildren,
      { type: 'text', x: 180, y: 126, text: 'antigen ON the cell', cls: 'caption', anchor: 'middle' },
      { type: 'text', x: 180, y: 140, text: 'hours', cls: 'caption', anchor: 'middle' },
      { type: 'text', x: 180, y: 156, text: `Coombs ${derived.directCoombs > 0.25 ? 'positive' : 'negative'}`, cls: 'caption', anchor: 'middle' },
      ...
      ...complexChildren,
      { type: 'text', x: 300, y: 126, text: 'antigen IN the plasma', cls: 'caption', anchor: 'middle' },
      { type: 'text', x: 300, y: 140, text: 'hours to days', cls: 'caption', anchor: 'middle' },
      { type: 'text', x: 300, y: 156, text: `C3 ${derived.c3MgDl.toFixed(0)} · C4 ${derived.c4MgDl.toFixed(0)}`, cls: 'caption', anchor: 'middle' },
      ...
      ...tissueChildren,
      { type: 'text', x: 420, y: 126, text: 'no antibody at all', cls: 'caption', anchor: 'middle' },
      { type: 'text', x: 420, y: 140, text: 'days', cls: 'caption', anchor: 'middle' },
      { type: 'text', x: 420, y: 156, text: `induration ${derived.indurationMm.toFixed(0)} mm`, cls: 'caption', anchor: 'middle' },
